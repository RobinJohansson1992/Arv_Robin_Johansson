namespace Arv_Robin_Johansson
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //create car:
            var car1 = new Car("Lexus", "RX90", 2005, 230,
                "svart", "tjutjutju..VROOOOM", 4);
            //displays info about the vehicle:
            car1.VehicleInfo();
            ...
            //create plane:
            var plane1 = new Plane("Mustang", "P-51", 1940, "röd",
                "fffFFFRRRRRRR...", 2000);
            ...
            //create moped:
            var moped1 = new Moped("Crescent", "Compact", 1970, "blå",
                "fr-r-r...fr-r-RR *PANG*", 30);
            ...
            Console.WriteLine($"Mopeden kan nu köra i {moped1.Trim()} km/h.");
            ...
            Console.ReadKey();
            //special method for sportscars:
            Console.WriteLine($"{lambo.Brand} {lambo.Model} har nu en " +
                $"maxhastighet på {lambo.ChangeToSportsMode()} km/h");
